    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Deskripsi</th>                 <td><textarea class='form-control' name='g'>$rows[deskripsi]</textarea><br/>*deksripsi diisi hanya untuk level menu utama</td></tr>
                    <tr><th scope='row'>Position</th>                  <td>"; if ($rows['position'] == 'Top'){
                                                                                echo "<input type='radio' name='d' value='Top' checked> Bottom 
                                                                                      <input type='radio' name='d' value='Bottom'> Top";
                                                                              }else{
                                                                                echo "<input type='radio' name='d' value='Top'> Bottom 
                                                                                      <input type='radio' name='d' value='Bottom' checked> Top";
                                                                              }
                    echo "</td></tr>
