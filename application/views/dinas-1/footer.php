...
?>
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
               <h2 class="mb-sm" style="text-align: center; font-size: 30px; font-weight: 300;">LOKASI</h2>
               <?php
				$iden = $this->model_utama->view_where('identitas',array('id_identitas' => 1))->row_array();
				$alamat = $this->model_utama->view_where('mod_alamat',array('id_alamat' => 1))->row_array();
				?>
			...
			<div class="col-md-4">
                <h2 class="mb-sm" style="text-align: center; font-size: 30px; font-weight: 300;">FANSPAGE</h2>
			...
			<div class="col-md-4">
                <h2 class="mb-sm" style="text-align: center; font-size: 30px; font-weight: 300;">Contact Us</h2>
