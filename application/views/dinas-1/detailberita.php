                                        ...
                                        <div class="owl-carousel owl-theme" data-plugin-options="{'items':1}">
                                            <div>
                                                <div class="img-thumbnail" style="display:inherit;">
                                                    <img style="width:100%" class="img-responsive" src="<?php echo "https://cdn.statically.io/img/ditjenbinaadwil.kemendagri.go.id/f=auto,w=800/asset/foto_berita/" . $rows['gambar'] ?>" alt="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
