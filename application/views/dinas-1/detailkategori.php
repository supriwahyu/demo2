										...
										<div class="col-md-5">
											<div class="img-responsive">
												...
												if ($row['gambar'] ==''){
													...
													echo "<a href='".base_url()."berita/detail/$row[judul_seo]' rel='bookmark' title='$row[judul]'><img width='336' style='height:189px;' height='189' class='img-responsive' src='https://cdn.statically.io/img/ditjenbinaadwil.kemendagri.go.id/f=auto,w=300/asset/foto_berita/$row[gambar]' alt='$row[gambar]' title='$row[judul]'/></a>";
												}
												?>
											</div>
										</div>
