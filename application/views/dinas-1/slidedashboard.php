<div id="carousel-example-generic" class="carousel slide">
        ...
        <div class="carousel-inner" role="listbox">
				...
				foreach ($utama1->result_array() as $row) {    
					...
					?>
					<img src="https://cdn.statically.io/img/ditjenbinaadwil.kemendagri.go.id/f=auto/asset/foto_banner/<?php echo $row['gambar'] ?>" class="img-responsive" style="width:1000px;height:auto;margin-left:400px"/>
