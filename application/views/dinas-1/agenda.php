								...
								<div class="row">
										<div class="col-md-5">
											<div class="img-responsive">
												<?php
												if ($h['gambar'] ==''){
													echo "<a href='".base_url()."agenda/detail/$h[tema_seo]' rel='bookmark' title='$h[tema]'><img width='336' style='height:189px;' height='189' class='img-responsive' src='https://cdn.statically.io/img/ditjenbinaadwil.kemendagri.go.id/f=auto/asset/foto_agenda/no-image.jpg' alt='$h[gambar]' title='$h[tema]'/></a>";
												}else{
													echo "<a href='".base_url()."agenda/detail/$h[tema_seo]' rel='bookmark' title='$h[tema]'><img width='336' style='height:189px;' height='189' class='img-responsive' src='https://cdn.statically.io/img/ditjenbinaadwil.kemendagri.go.id/f=auto/asset/foto_agenda/$h[gambar]' alt='$h[gambar]' title='$h[tema]'/></a>";
												}
												?>
											</div>
										</div>
