          ...
          foreach ($pasangiklan2->result_array() as $b) {
            ...
            if ($b['gambar'] != ''){
                if(preg_match("/swf\z/i", $string)) {
                    echo "<a href='$b[url]' target='_blank'><embed src='https://cdn.statically.io/img/ditjenbinaadwil.kemendagri.go.id/f=auto/asset/foto_pasangiklan/$b[gambar]' width=100% height=240 quality='high' type='application/x-shockwave-flash'></a>";
                } else {
                    echo "<a href='$b[url]' target='_blank'><img width=100% src='https://cdn.statically.io/img/ditjenbinaadwil.kemendagri.go.id/f=auto/asset/foto_pasangiklan/$b[gambar]' alt='$b[judul]' /></a>";
                }
            }
          }
        ?>
