<div class="vc_row td-top-border wpb_row td-pb-row" >
    <div class="vc_column wpb_column vc_column_container td-pb-span12">
        <div class="wpb_wrapper">
            ...
            <h4 class="block-title"><span class="td-pulldown-size">BERITA TERKINI</span></h4>
                                ...
                                <div class='td_module_1 td_module_wrap td-animation-stack'>
                                    <div class='td-module-image'>
                                        <div class='td-module-thumb'>";                            
                                            if ($row['gambar'] ==''){
                                                echo "<a href='".base_url()."berita/detail/$row[judul_seo]' rel='bookmark' title='$row[judul]'><img style='width:100%; height:160px' class='entry-thumb' src='https://cdn.statically.io/img/ditjenbinaadwil.kemendagri.go.id/asset/foto_berita/no-image.jpg' alt='$row[gambar]' title='$row[judul]'/></a>";
                                            }else{
                                                echo "<a href='".base_url()."berita/detail/$row[judul_seo]' rel='bookmark' title='$row[judul]'><img style='width:100%; height:160px' class='entry-thumb' src='https://cdn.statically.io/img/ditjenbinaadwil.kemendagri.go.id/asset/foto_berita/$row[gambar]' alt='$row[gambar]' title='$row[judul]'/></a>";
                                            }
                                        echo "</div>            
